...
public class Parser extends DefaultHandler {
	...
	private List<CicloFormativo> lst = new ArrayList<CicloFormativo>();
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		...
		if(qName.equals("ciclo")) {
			CicloFormativo c = new CicloFormativo(this.titulo, this.familia, this.grado, suma);
			lst.add(c);
		}
		
	}
	
	public List<CicloFormativo> getCicloFormativos() {
		return lst;
	}
}
